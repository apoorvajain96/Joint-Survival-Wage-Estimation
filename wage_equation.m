...
function func = wage_equation(D, sigma_ab, sigma_b, sigma_ac, sigma_bc,...
    sigma_a, sigma_c, sigma_e, ysm)
mu_a_bc_b = sigma_ab*(sigma_b^2) + sigma_ac*sigma_bc; % coeffs of b in mu_a_bc
mu_a_bc_c = sigma_ab*sigma_bc + sigma_ac*(sigma_c^2); % coeffs of c in mu_a_bc
sigma2_a_bc = (sigma_a).^2 - (sigma_ab*(sigma_b).^2 ...
